...
// import { RunHomeComponent } from './run-home/run-home.component';
...
@NgModule({
  ...
  imports: [RouterModule.forChild(routes), SharedModule, BarChartModule, LineChartModule, PieChartModule, AreaChartModule],
